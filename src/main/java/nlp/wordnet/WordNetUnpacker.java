 ...
 * Copied from https://raw.githubusercontent.com/AKSW/AutoSPARQL/9830e99d897200f8bcd448aa543c8f4cde4f7b3c/commons/src/main/java/org/aksw/autosparql/commons/nlp/wordnet/WordNetUnpacker.java
 * *
 */
public class WordNetUnpacker {
    ...
    static final String jarDir = "models/wordnet/en/dict";
    ...
    static File getUnpackedWordNetDir(Class clazz)// throws IOException
    {
        try {
            ...
            if (!codeSource.endsWith(".jar")) {
                ...
                try {
                    return new File(WordNetUnpacker.class.getClassLoader().getResource(jarDir).toURI());
     ...
     * Copied from <a href="http://stackoverflow.com/a/19859453/398963">Stack Overflow</a>.
     */
